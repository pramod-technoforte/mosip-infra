...
function installing_regproc() {
  ...
  helm -n $NS install regproc-group1 mosip/regproc-group1 -f group1_values.yaml --set image.repository=technogovstack/registration-processor-stage-group-1 --set image.tag=release-1.2.0.1.1 --version $CHART_VERSION
