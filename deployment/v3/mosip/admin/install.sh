...
function installing_admin() {
  ...
  helm -n $NS install admin-hotlist mosip/admin-hotlist --set image.repository=technogovstack/hotlist-service --set image.tag=release-1.2.0.1.1 --version $CHART_VERSION
